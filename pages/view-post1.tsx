...
import styles from "./view-post1.module.css";

const ViewPost1: NextPage = () => {
              ...
              <div className={styles.navbar}>
                <div className={styles.timefeedLowResolutionLogoBParent}>
                  ...
                  <div className={styles.menus}>
                    ...
                    <div className={styles.earn} onClick={onEarnTextClick}>
                      Earn
                    </div>
                    <div className={styles.explore}>Trade</div>
                    <div className={styles.earn} onClick={onPostTextClick}>
                      Post
                    </div>
                  </div>
                  <div className={styles.icon}>
                    <img
                      ...
                      alt=""
                      src="../Assets/account-circle-black-24dp-2-16.svg"
                    />
                    <img
                      className={styles.accountBalanceWalletBlack2Icon}
                      alt=""
                      src="../Assets/account-balance-wallet-black-24dp-5-16.svg"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className={styles.desktop1}>
                      ...
                      <div className={styles.usercard}>
                        ...
                        <button className={styles.rectangleGroup}>
                          <img
                            ...
                            alt=""
                            loading="lazy"
                            src="../Assets/TransperentText2@2x.png"
                          />
              ...
              <div className={styles.auctions2}>
                <div className={styles.usercard}>
                  ...
                  <button className={styles.usercardItem} />
                  <button className={styles.usercardInner} />
                  <button className={styles.rectangleContainer} autoFocus>
                    <img
                      className={styles.groupItem}
                      alt=""
                      src="../Assets/blurText17@2x.png"
                    />
                  ...
                  <button className={styles.groupButton}>
                    <img
                      ...
                      alt=""
                      loading="lazy"
                      src="../Assets/TransperentText3@2x.png"
                    />
              ...
              <div className={styles.favorit}>
                ...
                <div className={styles.like}>
                  ...
                  <div className={styles.explore}>82</div>
                </div>
              </div>
              ...
              <form className={styles.group481543default}>
                ...
                />
                <input
                  className={styles.textPlaceholder14}
                  type="text"
                  ...
                  <div className={styles.tetherUsdt}>
                    <div className={styles.tetherUsdt}>
                      <img
                        ...
                        alt=""
                        src="../Assets/rectangle-69541@2x.png"
                      />
              ...
              <img
                ...
                alt=""
                src="../Assets/vuesaxlineartetherusdt2.svg"
              />
            </div>
          </div>
        </div>
      ...
      <div className={styles.viewPostChild}>
        <div className={styles.vectorParent}>
          <img
            className={styles.vectorIcon}
            alt=""
            src="../Assets/vector102.svg"
          />
          <img
            className={styles.vuesaxboldheartIcon1}
            alt=""
            src="../Assets/vuesaxlinearheartslash75.svg"
          />
        </div>
      </div>
    </div>
