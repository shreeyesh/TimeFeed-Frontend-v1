...
const FrameComponent7: NextPage<FrameComponent7Type> = ({ onClose }) => {
  ...
  return (
    <div
      className={styles.withdrawSuccessPopupParent}
    ...
    >
      ...
      <div className={styles.rectangleParent}>
        <img
          ...
          alt=""
          src="../Assets/rectangle-6958@2x.png"
          onClick={onRectangleImageClick}
        />
        <div
          className={styles.congratulationsOnSuccessful}
        >{`Congratulations on successful withdraw `}</div>
      </div>
    </div>
  );
};
