...
import styles from "./under-construction-popup.module.css";

type UnderConstructionPopupType = {
  onClose?: () => void;
};

const UnderConstructionPopup: NextPage<UnderConstructionPopupType> = ({
  onClose,
}) => {
  ...
  return (
    <div className={styles.underConstructionPopup}>
      ...
      <div className={styles.frameParent}>
        ...
        <div className={styles.cta}>
          <img
            ...
            alt=""
            src="../Assets/play-circle-filled-black-24dp-1-14.svg"
          />
      ...
      <div className={styles.navbar}>
        <div className={styles.timefeedLowResolutionLogoBParent}>
          <img
            ...
            alt=""
            src="../Assets/timefeedlowresolutionlogoblackonwhitebackground-310@2x.png"
          />
          ...
          <div className={styles.buttonGroup}>
            <img
              ...
              alt=""
              src="../Assets/account-circle-black-24dp-2-110.svg"
            />
            <img
              className={styles.accountBalanceWalletBlack2Icon}
              alt=""
              src="../Assets/account-balance-wallet-black-24dp-5-110.svg"
            />
          </div>
        </div>
      </div>
      <img
        ...
        alt=""
        src="../Assets/timefeedlowresolutionlogoblackonwhitebackground-24@2x.png"
      />
      <img
        className={styles.notificationBingIcon}
        alt=""
        src="../Assets/notificationbing4.svg"
      />
    </div>
  );
};
